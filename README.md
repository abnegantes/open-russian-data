# open-russian-data
Подборка ресурсов с открытыми данными, ориентированная под использования в странах СНГ, или если вы делаете продукт и исследование про страны СНГ. Данные разбиты по темам и подходят как для дата-журналистики, так и для Data Science. Автор старался собирать данные, которые не нуждаются в большой предобработке (парсинг, очистка и т.п.). Если у вас есть вопросы и предложения, то пишите в Telegram:@Abnegantes. Давайте собирать больше открытой и хорошей даты.
...
4) [ТГ-канал с Российской датой](https://t.me/dataset_ru), где очень круто и местами больше всего, чем здесь.
...
3) [Витрина Росстата](https://showdata.gks.ru/finder/) во многом дублирует то, что указано выше. Но на витрине есть интересные детализации и дополнительные данные. Например, можно узнать средние зарплаты не только по регионам и отраслям, но дополнительно по типу предприятий — государственные, частные и т.п.
...
21) [Открытые данные федеральной таможенной службы](http://stat.customs.gov.ru/documents)
22) [Реестр ЖКХ. Сведения о домах в регионах, данные про аварийные дома и капитальный ремонт](https://www.reformagkh.ru/opendata)
23) [Статистика судебных решений от Судебного департамента при Верховном суде РФ ](https://beta.dostoevsky.io/ru/)
24) [Открытый туристический атлас мира OpenTripMap](https://opentripmap.com/)
25) [Карта возраста домов Москвы, Санкт-Петербурга, Екатеринбурга и ряда других городов России](https://kontikimaps.ru/how-old/dataset?p=h-menu)
...
12) [Открытые данные Московской биржи](https://www.moex.com/ru/derivatives/open-positions.aspx)
